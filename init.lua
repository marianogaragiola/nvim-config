...
-- vim.keymap.set('n', '<leader>c', '<cmd>bd<CR><cmd>bn<CR>')
...
-- local config_status_ok, nvim_tree_config = require('nvim-tree.config').nvim_tree_callback
...
vim.keymap.set('n', '<leader>e', '<cmd>NvimTreeToggle<cr>', { desc = 'NeoVim Tree' })
